					...
					<div class="table">
						...
						<form action="boardUpdateFormProc.jsp" method="post">
							<div class="line">
								...
								<div class="input"><%=bdto.getWriter() %></div>
							</div>
							<div class="line">
								<div class="name">이메일</div>
								<div class="input"><%=bdto.getEmail() %></div>
							</div>
							<div class="line">
								<div class="name">글제목</div>
								<div class="input"><input type="text" name="subject" value="<%=bdto.getSubject() %>"></div>
							</div>
							<div class="line">
								<div class="name">글내용</div>
								<div class="textarea"><textarea type="text" name="context"><%=bdto.getContext() %></textarea></div>
							</div>
